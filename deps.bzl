...
def go_dependencies():
    ...
    go_repository(
        ...
        replace = "github.com/arya-analytics/cockroach-go/v2",
        sum = "h1:Hyhzh8q6baGYeWz3nMyCHWhnM7R2Rz+nwf2v1psg2Zc=",
        version = "v2.2.9",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ULdarjI7FNUA6CNlLPIzSNvjdV2P4C2LSygPLvCVtfA=",
        version = "v0.6.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:5ek4bnrEmZo6wvY/RHt1dJNXzOPOnrfJeZMoZfZt9Io=",
        version = "v1.0.21",
    )
    go_repository(
        ...
        sum = "h1:2MoMW1qPpAQkwjNDBmQaZBAR07qpijJsw/p6gYzwdl0=",
        version = "v1.0.21",
    )
    go_repository(
        ...
        sum = "h1:ju1IgUidl+kBEg3AP0l8foDQIYyw0gARqFn7sFhnubQ=",
        version = "v1.0.15",
    )
    go_repository(
        ...
        sum = "h1:ILYJLqhx97I9WM+GbCYnF1QjNN63gpI2fvoj04atf8s=",
        version = "v1.0.21",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:2iGpcVyw4MnAyyXVJU2Xg6ZsbIxAOfRHo0LF5A5J0RA=",
        version = "v0.22.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:L+220cy+94UWmyBl1kiVTklBXrBtKsbjlPV60eL2u6s=",
        version = "v0.22.4",
    )
    go_repository(
        ...
        sum = "h1:uFSVSdW14JP53BCtMRsw1hB9ba21TBuUb5m7RvEsH0Y=",
        version = "v0.22.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:h7lBa5IuEUC4OQ45q/gIip/a0iQcML2iwrRmXksau30=",
        version = "v0.22.4",
    )
    go_repository(
        ...
        sum = "h1:7qwLJnua2ppGNZrRGDQ0vhsFebI39VGbZ4zdR5ArViI=",
        version = "v0.22.4",
    )
    go_repository(
        ...
        sum = "h1:Pso4iXoY6aYLCYQlNkME2MSJvAXo/7lnJYsWHdC6tvE=",
        version = "v0.22.4",
    )
    go_repository(
        name = "io_k8s_cri_api",
    ...
    go_repository(
        ...
        sum = "h1:ECUO1QWyZ70DiIKEfgBx+8i9D98uspVOwgc1APs/07w=",
        version = "v0.22.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:NNJ9d5ez7DfueE00bWmOkEvmpbCramppzDLw7L7XwRQ=",
        version = "v0.22.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:xn1OxcZEpgKpp4CCpPz1KKUyb9gAtTouXV2E3S8ChYQ=",
        version = "v3.7.2",
    )
    go_repository(
        name = "tools_gotest",
